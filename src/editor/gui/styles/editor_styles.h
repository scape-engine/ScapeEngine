...
struct EditorColor {
  // ---- Surfaces ----
  static constexpr ImU32 void_bg          = IM_COL32(18, 18, 18, 255);    // #121212 app bg behind cards
  static constexpr ImU32 panel            = IM_COL32(32, 32, 32, 255);    // #202020 panel cards / bars
  static constexpr ImU32 panel_stroke     = IM_COL32(48, 48, 48, 255);    // #303030 hairline under headers
  static constexpr ImU32 strip            = IM_COL32(23, 23, 23, 255);    // #171717 rulers / list strips
  static constexpr ImU32 recessed         = IM_COL32(17, 17, 17, 255);    // #111111 sunken zones
  static constexpr ImU32 input_bg         = IM_COL32(29, 29, 29, 255);    // #1D1D1D text fields
  static constexpr ImU32 control          = IM_COL32(48, 48, 48, 255);    // #303030 buttons / dropdowns
  static constexpr ImU32 control_hovered  = IM_COL32(58, 58, 58, 255);    // #3A3A3A
  static constexpr ImU32 control_border   = IM_COL32(66, 66, 66, 255);    // #424242 1px outline / separators
  static constexpr ImU32 control_selected = IM_COL32(49, 49, 49, 255);    // #313131 active tab / rail item
  ...
  static constexpr ImU32 selection_row = IM_COL32(49, 105, 227, 64);   // #3169E3 @ 0.25 row fill
  static constexpr ImU32 tree_guide    = IM_COL32(211, 211, 211, 153); // #D3D3D3 @ 0.6
  ...
  static constexpr ImU32 text_placeholder = IM_COL32(255, 255, 255, 102); // white @ 0.40
  static constexpr ImU32 text_disabled    = IM_COL32(211, 211, 211, 128);

  // ---- Accents ----
  static constexpr ImU32 accent           = IM_COL32(49, 105, 227, 255);  // #3169E3 toggled / playhead
  static constexpr ImU32 accent_border    = IM_COL32(91, 142, 255, 255);  // #5B8EFF
  static constexpr ImU32 accent_hover     = IM_COL32(82, 131, 232, 255);  // #5283E8
  static constexpr ImU32 accent_deep      = IM_COL32(38, 87, 135, 255);   // #265787 selection fill
  static constexpr ImU32 orange           = IM_COL32(225, 150, 88, 255);  // #E19658 active object
  static constexpr ImU32 orange_dim       = IM_COL32(192, 132, 83, 255);  // #C08453 selected text
  static constexpr ImU32 orange_row       = IM_COL32(192, 132, 83, 51);   // #C08453 @ 0.20 row bg
